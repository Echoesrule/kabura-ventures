...
var faqData = {
    ...
    bookings: {
        ...
        items: [
            ...
            { q: 'Can I book for a group?', a: 'Absolutely! During the booking process, you can specify the number of guests. For large groups or corporate retreats, <a href="/services#service-corporate">visit our Group & Corporate Travel page</a> or contact us directly for customized packages.' }
        ]
    },
    payments: {
        title: 'Payments',
    ...
    tours: {
        ...
        items: [
            ...
            { q: 'Are children allowed on tours?', a: 'Yes, children are welcome on most tours. Age restrictions may apply for certain adventure activities. Check the specific tour listing for age requirements or <a href="/services#service-tours">contact us</a> for family-friendly recommendations.' }
        ]
    },
    hotels: {
        title: 'Hotels',
        icon: 'bed',
        items: [
            { q: 'What types of accommodation do you offer?', a: 'We offer a wide range of accommodation options including luxury lodges, boutique hotels, budget-friendly guesthouses, beach resorts, and tented camps. Use the filters on our <a href="/hotels">Hotels page</a> to find the perfect stay for your budget and preferences.' },
            ...
            { q: 'Are airport transfers included?', a: 'Airport transfers are not automatically included in hotel bookings. However, you can add airport transfers through our <a href="/services#service-transport">Airport Transfers service</a> or request them when making your reservation.' }
        ]
    },
    policies: {
        title: 'Policies',
